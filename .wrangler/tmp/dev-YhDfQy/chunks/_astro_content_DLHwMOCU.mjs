...
import { o as objectType, f as dateType, e as arrayType, s as stringType, A as AstroError, R as RenderUndefinedEntryError, c as createComponent, q as unescapeHTML, a as renderTemplate, U as UnknownContentCollectionError, t as escape, v as renderUniqueStylesheet, w as renderScriptElement, x as createHeadAndContent, r as renderComponent } from './astro/server_pRuMz8GF.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D0R8qbwv.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://war3maps.net/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DeTyZ-Cv.mjs').then(n => n._);
